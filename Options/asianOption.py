...
if _name_ == "_main_":
    ...
    sigma = 0.2  # Volatility (you can adjust this value)
    stock = 150  # Initial stock price
    interest_rate = 0.042  # Risk-free interest rate

    # Simulation parameters
    n_simulations = 10000  # Number of Monte Carlo simulations
    n_steps = 252  # Number of time steps
    averaging_period = 0.3  # Averaging period in years


    # Initialize the AsianOption object
